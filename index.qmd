...
- Pixel width/height: scale calibration, read from metadata
    - can set yourself using a `Line` annotation
- Server type: how QuPath is reading the raw image file
...
- Preferences: customize QuPath behavior, including look-and-feel, extensions, etc.
...
- For Brush tool `Alt/Option` key enables subtract mode
- Magic wand: brush that takes into account intensity & zoom
